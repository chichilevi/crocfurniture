...
var GardenZone = function(){
	...
	var handleContactPopup = function(){
		var popup = '<div class="contant-no-area"><div class="contact-number"><h5>Have A Questions</h5><h6>+27 79 814 0524</h6></div><div class="contact-pic"><img src="/images/testimonials/pic4.jpg" alt=""/></div><div class="contact-name"><span>Chido Ngwenya</span></div><!-- Go to www.addthis.com/dashboard to customize your tools --><script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-5b221c5e31b4e54b"></script>';
